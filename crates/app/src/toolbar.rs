...
pub fn setup_toolbar_controls(
    ...
    ui.global::<CadActions>().on_trigger_command({
        move |cad_mode, id| {
            let res = sender.try_send(ControlMessage::AppMsg(AppMessage::ToolbarMsg {
...
pub fn setup_sketch_controls(mode_id: &str) -> SketchMessage {
    ...
    match mode_id {
        ...
        "sketch_tool_line" => SketchToolLineclicked,
        "sketch_tool_rectangle" => SketchToolRectangleClicked,
        _ => SketchModeClicked,
    }
}
